	nios_system u0 (
		...
		.orange_rand_export     (<connected-to-orange_rand_export>),     //     orange_rand.export
		.blue_rand_export       (<connected-to-blue_rand_export>),       //       blue_rand.export
		.red_rand_export        (<connected-to-red_rand_export>),        //        red_rand.export
		.pink_rand_export       (<connected-to-pink_rand_export>)        //       pink_rand.export
	);
